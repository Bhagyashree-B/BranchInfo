...
app.use('/shakha-mahiti', express.static(path.join(__dirname, 'dist/mean-angular6')));
//app.use('/book-details/:id', express.static(path.join(__dirname, 'dist/mean-angular6')));
app.use('/add-shakha-mahiti', express.static(path.join(__dirname, 'dist/mean-angular6')));
